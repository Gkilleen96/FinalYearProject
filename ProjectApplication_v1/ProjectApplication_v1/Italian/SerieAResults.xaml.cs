...
namespace ProjectApplication_v1
{
	...
	public partial class SerieAResults : ContentPage
	{
        apiData data = new apiData();
        string text = "";
        public SerieAResults (apiData d1)
		{
            InitializeComponent();
            data = d1;
        ...
        public void checkDate(String date)
        {
            ...
            var jsonObject = JObject.Parse(data.itaResults);


            int x = 29370;
            //fixture 1
            for (int i = 28990; i < 29370; i++)
            {
