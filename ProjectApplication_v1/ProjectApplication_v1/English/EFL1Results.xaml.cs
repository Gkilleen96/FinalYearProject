...
namespace ProjectApplication_v1
{
	...
	public partial class EFL1Results : ContentPage
	{
        apiData data = new apiData();
        string text = "";
		public EFL1Results (apiData d1)
		{
            InitializeComponent();
            data = d1;
        ...
        public void checkDate(String date)
        {
            ...
            var jsonObject = JObject.Parse(data.efl1Results);


            int x = 48679;
            //fixture 1
            for (int i = 48127; i < 48679; i++)
            {
