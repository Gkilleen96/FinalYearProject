...
namespace ProjectApplication_v1
{
	...
	public partial class BundesResults : ContentPage
	{
        apiData data = new apiData();
        string text= "";
		public BundesResults (apiData d1)
		{
            InitializeComponent();
            data = d1;
        ...
        public void checkDate(String date)
        {
            ...
            var jsonObject = JObject.Parse(data.gerResults);
            bool r1 = false;
            bool r2 = false;
            bool r3 = false;
            bool r4 = false;
            ...
            DateTime d1 = (DateTime)jsonObject["api"]["fixtures"]["69927"]["event_date"];
            String d2 = d1.ToString("yyyy-MM-dd");
            if (d2.Equals(d1))
            {
                if (!r1)
                {
                    TEAMH1.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH1.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA1.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA1.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME1.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH1.IsVisible = true;
                    r1 = true;
                }
                else if (!r2)
                {
                    TEAMH2.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH2.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA2.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA2.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME2.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH2.IsVisible = true;
                    r2 = true;
                }
                else if (!r3)
                {
                    TEAMH3.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH3.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA3.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA3.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME3.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH3.IsVisible = true;
                    r3 = true;
                }
                else if (!r4)
                {
                    TEAMH4.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH4.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA4.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA4.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME4.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH4.IsVisible = true;
                    r4 = true;
                }
                else if (!r5)
                {
                    TEAMH5.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH5.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA5.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA5.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME5.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH5.IsVisible = true;
                    r5 = true;
                }
                else if (!r6)
                {
                    TEAMH6.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH6.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA6.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA6.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME6.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH6.IsVisible = true;
                    r6 = true;
                }
                else if (!r7)
                {
                    TEAMH7.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH7.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA7.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA7.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME7.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH7.IsVisible = true;
                    r7 = true;
                }
                else if (!r8)
                {
                    TEAMH8.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH8.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA8.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA8.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME8.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH8.IsVisible = true;
                    r8 = true;
                }
                else if (!r9)
                {
                    TEAMH9.Text = jsonObject["api"]["fixtures"]["69927"]["homeTeam"].ToString();
                    SCOREH9.Text = jsonObject["api"]["fixtures"]["69927"]["goalsHomeTeam"].ToString();
                    TEAMA9.Text = jsonObject["api"]["fixtures"]["69927"]["awayTeam"].ToString();
                    SCOREA9.Text = jsonObject["api"]["fixtures"]["69927"]["goalsAwayTeam"].ToString();
                    TIME9.Text = jsonObject["api"]["fixtures"]["69927"]["statusShort"].ToString();
                    DASH9.IsVisible = true;
                    r9 = true;
                }
            }
