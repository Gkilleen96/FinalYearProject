...
namespace ProjectApplication_v1
{
    ...
    public partial class FLResults : ContentPage
    {
        apiData data = new apiData();
        string text="";
        public FLResults(apiData d1)
        {
            InitializeComponent();
            data = d1;
        ...
        public void checkDate(String date)
        {
            ...
            var jsonObject = JObject.Parse(data.fraResults);


            int x = 37933;
            //fixture 1
            for (int i = 37553; i < 37933; i++)
            {
